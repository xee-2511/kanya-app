  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        width: '100%', maxWidth: '900px', minHeight: '560px'
      }}>

        {/* Left Panel — Manual Carousel */}
        <div style={{
          flex: 1,
            ...
            <div style={{ position: 'relative' }}>
              <input
                ...
                style={{
                  ...
                  borderRadius: '12px', border: '1.5px solid #f8e2ec',
                  background: '#fff7fa', fontSize: '0.95rem', color: '#4A4A4A',
